...
import { Trophy, TrendingUp, Calendar, Users, Target, Award, ChevronDown, ChevronUp, Clock, RefreshCw } from 'lucide-react';
import { supabase } from '../../lib/supabase';
import { useAuth } from '../../contexts/AuthContext';
import { useGameweek } from '../../hooks/useGameweek';
import LivePointsTracker from '../fantasy/LivePointsTracker';
...
export default function TeamPointsHistory() {
  ...
  if (gameweekPoints.length === 0 && activeTab === 'history') {
    return (
      <div className="space-y-6">
        {/* Header */}
        <div className="bg-white rounded-xl shadow-sm p-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Team Points</h1>
          <p className="text-gray-600">
            Track your fantasy team's performance and live points.
          </p>
        </div>
        ...
        {activeTab === 'live' ? (
          <LivePointsTracker fantasyTeamId={fantasyTeamId} />
        ) : (
